...
class PuzzleUI:
    def __init__(self, root, actions, states):
        ...
        self.root.title("8 Puzzle DFS Agent Visualizer")
    ...
    def update_board(self):
        ...
        if self.index == 0:
            ...
            self.status_label.config(text="Agent đang lần theo lời giải DFS")
